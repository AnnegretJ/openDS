...
public class TrafficLightPhase 
{
	...
	/**
	 * Returns the number of milliseconds since the activation of the phase. This 
	 * value can be computed by subtracting the time to expiration from the duration 
	 * time.
	 * 
	 * @param currentTime
	 * 			Current time stamp
	 ...
	 */
	public long timeSinceActivation(long currentTime)
	{
		long timeToExpiration = timeToExpiration(currentTime);
		return Math.max(0, (duration - timeToExpiration));
	}
