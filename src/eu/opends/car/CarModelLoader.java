...
public class CarModelLoader
{
	...
	private Node invisibleCarNode = new Node();
	...
	public CarModelLoader(Simulator sim, Car car, String modelPath, float mass, Vector3f initialPos, Quaternion initialRot)
	{
        ...
        {   
	        ...
	        */
	        ...
	        Util.findNode(carNode, "chassis").setLocalTranslation(centerOfMass.negate().add(chassisPosition));
	        ...
	        invisibleCarNode.addControl(bulletVehicleControl);
	        ...
	        */
	        ...
	        invisibleCarNode.attachChild(carNode);
	        sim.getSceneNode().attachChild(invisibleCarNode);
        }
        else
        {
    		// Chrono parameters
			...
			// new Chrono vehicle
    		Vector3f frontSuspensionPos = new Vector3f(getVector3f(properties, "frontSuspensionPos", 0));
    		Vector3f rearSuspensionPos = new Vector3f(getVector3f(properties, "rearSuspensionPos", 0));
    		
        	ChronoVehicleControl chronoVehicleControl = new ChronoVehicleControl(sim, initialPos, initialRot, 
        			frontSuspensionPos, rearSuspensionPos, chronoDataPath, terrainFile, textureFile);
			...
			chassisSpatial.setLocalTranslation(chassisPosition);
			...
			invisibleCarNode = chronoVehicleNode;
