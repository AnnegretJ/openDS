	...
	public void onAction(String binding, boolean value, float tpf) 
	{
		...
		else if (binding.equals(KeyMapping.SHIFT_UP.getID())) 
		{
			if (value)
			{
				...
				car.getCarControl().shiftUp(false);
			}
		}
		...
		else if (binding.equals(KeyMapping.SHIFT_DOWN.getID())) 
		{
			if (value)
			{
				...
				car.getCarControl().shiftDown(false);
			}
		}
		...
		else if (binding.equals(KeyMapping.TOGGLE_AUTOMATIC.getID())) 
		{
			if (value)
			{
				car.getCarControl().setAutomatic(!car.getCarControl().isAutomatic());
			}
		}
		...
		else if (binding.equals(KeyMapping.AUTO_STEER.getID())) 
		{
			if (value)
			{
				...
				car.setODAutoPilot(!car.isODAutoPilot());
			}
		}
		...
		{
			if(value)
				car.getCarControl().setGear(-1, false, true);
			else
				car.getCarControl().setGear(0, false, true);
		}
		...
		{
			if(value)
				car.getCarControl().setGear(2, false, true);
			else
				car.getCarControl().setGear(0, false, true);
		}
		...
		{
			if(value)
				car.getCarControl().setGear(3, false, true);
			else
				car.getCarControl().setGear(0, false, true);
		}
		...
		{
			if(value)
				car.getCarControl().setGear(4, false, true);
			else
				car.getCarControl().setGear(0, false, true);
		}
		...
		{
			if(value)
				car.getCarControl().setGear(5, false, true);
			else
				car.getCarControl().setGear(0, false, true);
		}
		...
		{
			if(value)
				car.getCarControl().setGear(6, false, true);
			else
				car.getCarControl().setGear(0, false, true);
		}
