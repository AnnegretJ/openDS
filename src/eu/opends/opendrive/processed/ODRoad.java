...
public class ODRoad 
{
	...
	public ODRoad(SimulationBasics sim, TRoad road) 
	{
		...
		this.road = road;
		this.geometryList = road.getPlanView().getGeometry();
...
*/
	...
	public double getEndS()
	{
		...
		if(!roadReferencePointlist.isEmpty())
		{
			ODPoint lastPoint = roadReferencePointlist.get(roadReferencePointlist.size()-1);
			endS = lastPoint.getS();
		}
