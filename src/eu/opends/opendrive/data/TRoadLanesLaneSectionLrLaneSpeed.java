 ...
 *       &lt;attribute name="max" use="required" type="{}t_grEqZero" />
...
@XmlType(name = "t_road_lanes_laneSection_lr_lane_speed", propOrder = {
    "userData",
    "include",
    "dataQuality"
})
public class TRoadLanesLaneSectionLrLaneSpeed {
