...
public class DrivingTask 
{
	...
	{
		return dtData.getScenePath();
	}
	
	public String getScenarioPath()
	{
		return dtData.getScenarioPath();
	}
	
	public String getInteractionPath()
	{
		return dtData.getInteractionPath();
	}
	
	public String getSettingsPath()
	{
		return dtData.getSettingsPath();
	}
	
	public String getTaskPath()
	{
		return dtData.getTaskPath();
	}
	
	public String getOpenDrivePath()
	{
		return dtData.getOpenDrivePath();
	}
	...
	public DrivingTask(SimulationBasics sim, File xmlfile) 
	{
		...
		interactionLoader = new InteractionLoader(dtData, sim, this);
