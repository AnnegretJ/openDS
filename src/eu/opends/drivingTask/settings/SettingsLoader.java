...
public class SettingsLoader
{
	...
	public enum Setting
	{
		...
		Chrono_terrainModel("settings:chrono/settings:terrainModel/@ref"),
		...
		Joystick_enableSpringForce("settings:controllers/settings:joystick/settings:enableSpringForce"),
		Joystick_enableDamperForce("settings:controllers/settings:joystick/settings:enableDamperForce"),
		Joystick_enableSurfaceEffect("settings:controllers/settings:joystick/settings:enableSurfaceEffect"),
		Joystick_enableCollisionEffect("settings:controllers/settings:joystick/settings:enableCollisionEffect"),
		Joystick_enableAirborneEffect("settings:controllers/settings:joystick/settings:enableAirborneEffect"),
		Joystick_enableGhostWheel("settings:controllers/settings:joystick/settings:enableGhostWheel"),
		...
		Codriver_enableConnection("settings:codriver/settings:enableConnection"),
		Codriver_libName("settings:codriver/settings:libName"),
		Codriver_ip("settings:codriver/settings:ip"),
		Codriver_port("settings:codriver/settings:port"),
		Codriver_enableLog("settings:codriver/settings:enableLog"),
		Codriver_logFolder("settings:codriver/settings:logFolder"),
		Codriver_logType("settings:codriver/settings:logType"),
		Codriver_noOfDiscardedScenarioMsgs("settings:codriver/settings:noOfDiscardedScenarioMsgs"),
		Codriver_sequentialMsgExchange("settings:codriver/settings:sequentialMsgExchange"),
		General_UseFixedSimulationStep("settings:general/settings:useFixedSimulationStep"),
		General_FixedSimulationStepSize("settings:general/settings:fixedSimulationStepSize"),
		ScenarioMessage_SendToCodriver("settings:scenarioMessage/settings:sendToCodriver"),
		ScenarioMessage_UpdateRate("settings:scenarioMessage/settings:updateRate"),
		ScenarioMessage_UseReferenceLane("settings:scenarioMessage/settings:useReferenceLane"),
		ScenarioMessage_ShowMessageBox("settings:scenarioMessage/settings:showMessageBox"),
		ScenarioMessage_PrintStatusMsg("settings:scenarioMessage/settings:printStatusMsg"),
		ScenarioMessage_PrintCSVMsg("settings:scenarioMessage/settings:printCSVMsg"),
		...
		ScenarioMessage_VisualizeTrajectoryBackcast("settings:scenarioMessage/settings:visualizeTrajectoryBackcast"), 
	...
	{		
		try {
			...
			String stringValue = (String) dtData.getValue(Layer.SETTINGS, setting.getXPathQuery(), String.class);
