...
public class SimulationBasics extends SimpleApplication 
{
	...
	protected static Map<ODPosition, Trigger> ODTriggerActionListMap = new HashMap<ODPosition, Trigger>();
	...
	public static Map<ODPosition, Trigger> getODTriggerActionListMap() 
	{
		return ODTriggerActionListMap;
	}
	...
	protected OpenDriveCenter openDriveCenter;
