...
public class FollowBoxSettings 
{
	...
	private boolean resetWhenStuck;
	...
	public FollowBoxSettings(ArrayList<Segment> preferredSegments, float minDistance, float maxDistance, 
			...
			float minIntersectionClearance, boolean resetWhenStuck) 
	{
		...
		this.resetWhenStuck = resetWhenStuck;
	...
	public boolean getResetWhenStuck() 
	{
		return resetWhenStuck;
	}
	
	
	public void setResetWhenStuck(boolean resetWhenStuck)
	{
		this.resetWhenStuck = resetWhenStuck;
	}
