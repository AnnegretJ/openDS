 ...
 * @author Rafael Math
 */
public class SetSpeedLimitTriggerAction extends TriggerAction 
{
	private int speedLimit;
	private boolean currentSpeedLimit;
	
	
	public SetSpeedLimitTriggerAction(float delay, int maxRepeat, int speedLimit, boolean currentSpeedLimit)
	{
